...
echo $html->div('comparator-download', $html->link($html->image("download-medium.png",array("title" => 'Download Blast Results')), array('controller'=> 'blast','action'=>'download'),array('escape' => false)));	
echo("</fieldset>");
?>
