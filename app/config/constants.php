...
define('PHP_HTTP_TRANSPORT_CURL_REUSE', 'Curl');
define('PHP_HTTP_TRANSPORT_CURL_NOREUSE', 'CurlNoReuse');
define('PHP_HTTP_TRANSPORT_FILE_GET_CONTENTS', 'FileGetContents');